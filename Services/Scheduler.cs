...
namespace FlashMemo.Services
{
    ...
    public static class Scheduler
    {
        ...
        private static ScheduleInfo ProcessHard(Card card, DeckOptions.SchedulingOpt s)
        {
        ...
        private static ScheduleInfo ProcessEasy(Card card, DeckOptions.SchedulingOpt s)
        {
            return new(
        ...
        private static ScheduleInfo ProcessGood(Card card, DeckOptions.SchedulingOpt s)
        {
            return card.State switch
            {
                CardState.New => new(
        ...
        private static ScheduleInfo ProcessGoodIfLearningStage(Card card, DeckOptions.SchedulingOpt s)
        {
        ...
        private static ScheduleInfo ProcessAgain(Card card, DeckOptions.SchedulingOpt s)
        {
            return card.State switch 
            {
                CardState.Review => new(
